...
print("--- Начало обучения: Вариант 2 'Реабилитация Гиганта' (Multi-GPU) ---")
...
# --- 1. Подготовка данных ---
DATA_PATH = '/home/jupyter/project/yara/train.parquet'
...
# ================================================================= #
# ==== ГИПЕРПАРАМЕТРЫ ДЛЯ ВАРИАНТА 2: "РЕАБИЛИТАЦИЯ ГИГАНТА" ==== #
# ================================================================= #
input_dim = len(feature_cols)
d_model = 256            # Широкая модель
nhead = 8                # 256 % 8 == 0, OK
num_encoder_layers = 4
dim_feedforward = 1024   # d_model * 4
dropout = 0.4            # Агрессивная регуляризация

learning_rate = 1e-4     # Пониженная скорость обучения
num_epochs = 30
...
fig.suptitle('Результаты обучения: Вариант 2 "Реабилитация Гиганта" (Multi-GPU)', fontsize=16)
...
# ИЗМЕНЕНО: Имя файла для сохранения графика
plt.savefig('training_metrics_giant_rehab_multi_gpu.png')
print("Графики обучения сохранены в файл 'training_metrics_giant_rehab_multi_gpu.png'")